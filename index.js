...
//🚀🚀🚀 ⬇️ 📝 Explanation ⬇️ 📝 🚀🚀🚀: 
//NestedFunction has access to everything inside of myFunction because it is nested inside of it and const internal is within the scope of myFunction. 
...
const zooAnimals = [
  ...
  */
  ...
  function animalNames(arr){
    ...
    display.push(`name: ${item.animal_name}, scientific: ${item.scientific_name}`)
    })
    return display
  };
